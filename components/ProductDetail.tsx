          ...
          <div className="flex flex-col justify-center max-w-xl">
             ...
             <div className="flex flex-col gap-4">
               ...
               <button 
                 ...
                 className={`w-full py-5 border border-[#2C2A26] uppercase tracking-widest text-sm font-medium transition-all duration-300 flex items-center justify-center gap-3 ${
                   isFavorite 
                     ? 'bg-[#2C2A26] text-[#F5F2EB]' 
                     : 'text-[#2C2A26] hover:bg-[#2C2A26] hover:text-[#F5F2EB]'
                 }`}
               >
                 <Heart size={18} className={isFavorite ? 'fill-[#F5F2EB]' : ''} />
